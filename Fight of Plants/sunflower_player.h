#ifndef _SUN_FLOWER_PLAYER_H_
#define _SUN_FLOWER_PLAYER_H_
...
public:
	...
	void on_attack_ex()
	{
		...
		bullet_list.push_back(bullet);
		mciSendString(_T("play sun text from 0"), NULL, 0, NULL);
	}
...
private:
	const float	speed_sun_ex = 0.160f;
	const Vector2 velocity_sun = {0.25f, -0.5f};

private:
	Animation animation_sun_text; // 头顶文字动画
	bool is_sun_text_visible = false; // 是否显示大日
};
#endif // !_SUN_FLOWER_PLAYER_H_
